<template>
  <view>
    ...
    <view class="image-list">
      <lazy class="image" width="230rpx" height="230rpx" v-for="(item,index) in items.images_text" :key="index" :src="item"
        mode="aspectFill"></lazy>
      <!-- <image v-for="(item,index) in items.images_text" mode="aspectFill" :key="index" :src="item"></image> -->
    </view>
    <view class="img-down">
      <view class="left">
      ...
      <view class="right">
        <image v-if="items.give == 1" @tap="dianzan" src="../../static/images/121.png"></image>
    ...
    <view class="guanggao" v-for="(item,index) in gglist" :key="index" @tap="openurl(item)">
      <lazy :src="item.image_text" width="710rpx" height="160rpx"></lazy>
