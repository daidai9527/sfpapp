<template>
  <view class="shequ-photo">
    <view class="shequ-header" @tap.stop="toinfo">
      <view class="shequ-header-left" @tap.stop="touserinfo">
        ...
        <view class="header-userinfo">
          <view class="userinfo" v-if="items.publisher">
      ...
      <view class="shequ-header-right">
        <text class="shequ-header-right1">現場記錄</text>
        <text class="shequ-header-right2">@</text>
      </view>
      <!-- <image class="shequ-header-right" src="/static/images/46.png"></image> -->
    </view>
    <view class="item-text" @tap.stop="toinfo">
      <!-- <text class="item-text-title" v-if="items.labels.name">{{items.labels.name}}</text> -->
      <text class="item-text-content">{{items.title}}</text>
    </view>
    <index-swiper :imglist="items.images_text"></index-swiper>
...
<style>
  ...
  .item-text-title {
    ...
    width: 74rpx;
    height: 36rpx;
    background-color: rgba(255, 180, 38, 1);
    border-radius: 4rpx;
    font-size: 24rpx;
    font-weight: 400;
